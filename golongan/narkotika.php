...
<body>
   <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
      <div class="container">
         <a class="navbar-brand text-light" href="../index.php">SIPENAP</a> <button
                  ...
                  <div class="card-labels">
                     ...
                     <ul style="margin: 0; padding: 0">
                        <li style="list-style: none; margin-bottom: .5rem">
                           <a class="text-dark"
                              href="../single page/gol-narkotika.php?id=<?php echo $singlePage['id_golongan']; ?>"><?php echo $singlePage["golongan"]; ?></a>
                        </li>
                     </ul>
                     <?php } ?>
                  </div>
